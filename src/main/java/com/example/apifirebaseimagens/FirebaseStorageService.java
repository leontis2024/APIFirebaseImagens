...
public class FirebaseStorageService {
    private String uploadFile(File file, String fileName,String nomeTabela) throws IOException {
        ...
        InputStream inputStream = FirebaseStorageService.class.getClassLoader().getResourceAsStream("leontisfotos-firebase-adminsdk-3nepr-4b41f628f0.json"); // change the file name with your one
